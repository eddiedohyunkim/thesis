	const typeArea = document.getElementById('viewport');
	const font = {
	...
	const sentence = 'A possible strategy against algorithmic recognition';
...
const bluediv = document.getElementById('move');
var width = viewport.scrollWidth;
console.log(width);
